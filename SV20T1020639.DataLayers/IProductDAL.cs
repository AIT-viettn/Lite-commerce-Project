...
namespace SV20T1020639.DataLayers
{
    public interface IProductDAL
    {
        ...
        /// <param name="categoryID">Mã loại hàng cung cấp (0 nếu không tìm theo loại hàng) </param>
        ...
        /// <param name="supplierID">Mã nhà cung cấp cần tìm (0 nếu không tìm theo nhà cung cấp)</param>
        /// <param name="minPrice">Mức giá nhỏ nhất trong khoảng giá cần tìm</param>
        /// <param name="maxPrice">Mức giá lớn nhất trong khoảng giá cân tìm (0 nếu không hạn chế mức giá lớn nhất)</param>
        /// <returns></returns>
        ...
        /// <param name="data"></param>
        /// <returns></returns>
        long AddAtrribute(ProductAttribute data);
        /// <summary>
        /// Cập nhật thuộc tính mặt hàng
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        bool UpdateAtrribute(ProductAttribute data);
        /// <summary>
        /// xóa thuộc tính
        /// </summary>
        /// <param name="productID"></param>
